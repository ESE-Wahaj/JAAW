      ...
      items: [
        <Link to="/">
          <EuiText>
            ...
            {/* <EuiHeaderLogo iconType={logoh} ></EuiHeaderLogo> */}
              <EuiImage src={logo} alt="logo" size="100px" />
              {/* <EuiTextColor color="#53b9fb">J</EuiTextColor>
              <EuiTextColor color="#5671f8">A</EuiTextColor>
              <EuiTextColor color="#f75f60">A</EuiTextColor>
              <EuiTextColor color="#53b9fb">W</EuiTextColor> */}
            </h2>
          </EuiText>
        </Link>,
      ],
